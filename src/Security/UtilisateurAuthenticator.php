...
class UtilisateurAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    {
        $credentials = [
            'nomDeLaSociete' => $request->request->get('nomDeLaSociete'),
            'password' => $request->request->get('password'),
            'csrf_token' => $request->request->get('_csrf_token'),
        ];
        $request->getSession()->set(
            Security::LAST_USERNAME,
            $credentials['nomDeLaSociete']
        );
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->entityManager->getRepository(Utilisateur::class)->findOneBy(['nomDeLaSociete' => $credentials['nomDeLaSociete']]);
